...
/* Qwerty */
[ALPHAS] = LAYOUT_zplit_2x2u(
   KC_ESC,		  KC_Q,    KC_W,    KC_E,  KC_R,   KC_T,    	KC_Y,	KC_U,	KC_I,	 KC_O,	  KC_P,	   KC_DEL,
   KC_TAB,  	  KC_A,    KC_S,    KC_D,  KC_F,   KC_G,    	KC_H,	KC_J,   KC_K,    KC_L,	  KC_QUOT, KC_BSPC,
   LGUI(KC_SCLN), KC_Z,    KC_X,    KC_C,  KC_V,   KC_B,		KC_N,	KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
   KC_LCTL,		  KC_LGUI, KC_LALT, LOWER,	  KC_LSFT,				KC_SPC,		RAISE,	 KC_MINS, KC_SCLN, KC_EQL
),

/* Numbers and symbols */
[NUM_SYM] = LAYOUT_zplit_2x2u(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 		KC_TRNS,			KC_P0,    POWPOW, KC_PDOT, KC_EQL,  KC_PENT
),

/* Nav and extended symbols */
[NAV_eSYM] = LAYOUT_zplit_2x2u(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, POWPOW,		KC_TRNS,			KC_SPC,		  KC_TRNS, _______, _______,  POWPOW
),

/* F-Keys and superuser functions (usable single handed)*/
[ADMIN] = LAYOUT_zplit_2x2u(
  RESET,   DEBUG,	KC_WAKE, XXXXXXX, XXXXXXX, XXXXXXX,		KC_F9, KC_F10, KC_F11,  KC_F12,	 XXXXXXX, RESET,
  KC_TRNS, XXXXXXX, KC_SLEP, XXXXXXX, XXXXXXX, XXXXXXX,		KC_F5, KC_F6,  KC_F7,   KC_F8,	 XXXXXXX, XXXXXXX,
  KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,		KC_F1, KC_F2,  KC_F3,   KC_F4,	 XXXXXXX, XXXXXXX,
  KC_TRNS, KC_TRNS,	KC_TRNS, KC_TRNS,		KC_TRNS,			KC_TRNS,   KC_TRNS, XXXXXXX, DEBUG,	  XXXXXXX
)
